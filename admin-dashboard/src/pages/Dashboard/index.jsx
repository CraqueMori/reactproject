...
const Dashboard = () => {
  ...
  const reports = [
  { title: "Vendas", iconClass: "fa-bag-shopping", description: "1.055", percent: "+1.2" },
  { title: "Custo da Aplicação", iconClass: "fa-money-check-dollar", description: "R$ 15000", percent: "-5" },
  {
    title: "Vendas Totais",
    iconClass: "fa-sack-dollar",
    description: "R$ 100.000",
    percent: "+20"
  },
];
